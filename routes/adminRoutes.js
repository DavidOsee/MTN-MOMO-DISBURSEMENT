...
const { Login, Log_me_in, Logout, Home, TransFee, Profile, Users, Register, Admin_register, Delete_user,  ForgotPwd, ForgotPwd_otp, Password_reset, SendOTP, ValidateOTP, ResetPwd, SelfAccountDeleted, UpdateProfile} = require('../controllers/adminController.js')
...
.post('/updateProfile', Protect, UpdateProfile)
